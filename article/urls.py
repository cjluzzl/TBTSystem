...
from .views import ArticleListView, ArticleDetailView,\
    HomeNewsJsonListView, AbroadNewsJsonListView, ArticleJsonView, ArticleMobileDetailView
...
urlpatterns = [
    ...
    url(r'^mobile_detail/(?P<article_id>.*)/$', ArticleMobileDetailView.as_view(), name="article_detail"),
