...
"""
Django settings for TBTSystem project.
...
SECRET_KEY = 'm@w)9&-$gs5)+2#5vux!_kq@09dllc%cz+n07%(r^bdjd^k6_m'
...
WSGI_APPLICATION = 'TBTSystem.wsgi.application'
